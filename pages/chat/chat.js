        ...
        <div className={active ? activeSide : hiddenSide}>
          <div class="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full p-4">
                ...
                <div class="grid grid-cols-12 gap-y-2">
                  <div class="col-start-1 col-end-8 p-3 rounded-lg">
                    <div class="flex flex-row items-center">
                      <div class="flex items-center justify-center h-10 w-10 rounded-full instaBg flex-shrink-0">
                        A
                      </div>
            ...
            <div class="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
              ...
              <div class="ml-4">
                <button class="flex items-center justify-center instaBg hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0">
                  <span>Send</span>
                  <span class="ml-2">
                    <svg
